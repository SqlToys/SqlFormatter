...
//TestQuery( 'SELECT 1 - -1 FROM DUAL;' );     { ** MUST BE WRONG ** }
  ...
  TestQuery( '/* po FORMAT jest problem z niew³aciwym listowaniem nawiasów */'#13#10 +
             'SELECT  *'#13#10 +
             'FROM    tab'#13#10 +
  ...
  TestQuery( '-- zamiana zapasów jeli wskazuj¹ wêz³y odwrotnie do kierunku punktów charakterystycznych.'#13#10 +
  ...
  TestQuery( 'CREATE OR REPLACE   VIEW WLOKNO_POM_WKV AS'#13#10 +
             ...
             '-- d³ugoæ optyczna z ostatniego pomiaru'#13#10 +
             'LEFT JOIN ('#13#10 +
             '          SELECT *'#13#10 +
